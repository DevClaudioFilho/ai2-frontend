    ...
    <>
      ...
      <section className="container my-4">
        <div>
          ...
          <div className="d-flex justify-content-around mx-auto m-4" style={{gap:'15px',width:600}}>
            <Link to="" className='hover_ligth'>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="gray" class="bi bi-instagram " viewBox="0 0 16 16">
            ...
            <Link to="" className='hover_ligth'>
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="gray" class="bi bi-twitter" viewBox="0 0 16 16">
